...
//Function that will handle site registrations
...
// Get client data based on an clientId address
function getClientWId($clientId)
{
    $db = phpmotorsConnect();
...
function updateAccount($clientFirstname, $clientLastname, $clientEmail, $clientId)
{
    ...
    $db = phpmotorsConnect();
    // The SQL statement
    $sql = 'UPDATE clients SET clientFirstname = :clientFirstname, clientLastname = :clientLastname, clientEmail = :clientEmail, clientId = :clientId 
...
function updatePassword($clientPassword, $clientId)
{
    ...
    $db = phpmotorsConnect();
    // The SQL statement
    $sql = 'UPDATE clients SET clientPassword = :clientPassword, clientId = :clientId 
    WHERE clientId = :clientId';
    // Create the prepared statement using the phpmotors connection
    $stmt = $db->prepare($sql);
    // The next four lines replace the placeholders in the SQL
